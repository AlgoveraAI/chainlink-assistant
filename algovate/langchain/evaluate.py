...
def run_eval(
    ...
    try:
        ...
        retrieved_doc_text = ""
        docs = retriever.get_relevant_documents(ground_truth["question"])
...
def run_experiment(
    ...
    k = experiment_config.get("k", 4)
    score_threshold = experiment_config.get("score_threshold", 0.5)
...
def run_experiments(
    yaml_file,
    yaml_type, # "generate" or "experiment" 
):
