...
def get_github_docs(
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        markdown_files = [file for file in markdown_files if file.name.endswith('course.md')]
        ...
        for markdown_file in markdown_files:
            with open(markdown_file, "r") as f:
                ...
                read = f.read()
                documents.append(Document(page_content=read, metadata={"source": github_url, "type": "education"}))
